/*-------------------------------------------------------------------------------------*/
/*  Styren MATLAB Interface                                                            */
/*  Author: Christophe Tribes 2015                                                     */
/*                                                                                     */
...
/*-------------------------------------------------------------------------------------*/
// Date September 18th, 2015 --- V 1.0
// The interface is:
//      [fval,exitflag] = bb(x)
...
{
    //Get xtype
    if( nrhs !=1 || mxIsEmpty(prhs[0]) || ! ( mxGetN(prhs[0])==8 || mxGetM(prhs[0])==8 ) )
        mexErrMsgTxt("Invalid input for styren bb!");
