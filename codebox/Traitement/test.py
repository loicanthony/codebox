...
def assim_imfil(read,plot):
    ...
    algos = {'i' : 'imfil'}
    strategies = ['n', 'ol', 'os', 'om','or','oo','on']
    path2results = 'C:\\Users\\Loic\\Documents\\RDOSC\\Executions\\MATLAB_IMFIL\\current'
    ...
    if plot:
        ...
        ratios = [0.1, 0.01, 0.001]
        logs = [True,False]
        path2file = 'C:\\Users\\Loic\\Documents\\RDOSC\\Executions\\MATLAB_IMFIL\\current\\plot_data\\'
